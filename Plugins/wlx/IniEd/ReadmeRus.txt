...
2. Раcпакуйте IniEd.wlx в каталог с плагинами (например c:\wincmd\plugins).
...
6. Нажмите кнопку "Добавить" ("Add") и выберите IniEd.wlx. Нажмите 'OK'.
7. Пользуйтесь. ;-)
...
v. 2.0 - XX.XX.2013
  ...
  [*] Отключено сообщение о превышении длины строки
...
v. 0.2 Alpha - 31.01.2004
  [!] Первая рабочая версия.
      Немного медленная, но, как ни странно, почти безглючная.
